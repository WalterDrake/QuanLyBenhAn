...
namespace DO_AN_CUA_HAN.View
{
    public partial class FormDatabase : Form
    {
            ...
            private void bunifuButton11_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuSnackbar1.Show(this, "Nhập tài khoản", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Warning, 1000, null, Bunifu.UI.WinForms.BunifuSnackbar.Positions.TopCenter);
                return;
            }
            if (string.IsNullOrEmpty(bunifuTextBoxPassword.Text))
            {
                bunifuSnackbar1.Show(this, "Nhập mật khẩu", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Warning, 1000, null, Bunifu.UI.WinForms.BunifuSnackbar.Positions.TopCenter);
                return;
            }
